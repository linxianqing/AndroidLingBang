...
//    URL resource = TestDaoGenerator.class.getResource("");
    Schema schema = new Schema(1, "lin.com.androidlingbang.entity");
    schema.setDefaultJavaPackageDao("lin.com.androidlingbang.dao");
//    addNote(schema);
    addAccount(schema);
  ...
  private static void addAccount(Schema schema) {
    Entity note = schema.addEntity("Account");
    note.addIdProperty().primaryKey().autoincrement();    //设置主键
    note.addStringProperty("username");         //设置string字段username
...
//    daoGenerator.generateAll(schema, "../app/src/main/java-gen");
//    daoGenerator.generateAll(schema2, "../app/src/main/java-gen");
//    daoGenerator.generateAll(schemaUnitTest, "../app/src/test/java-gen");
//  }
//
